...
- **[sortition-worker-guide-2026-07-17.md](sortition-worker-guide-2026-07-17.md)** - REQUIRED UPDATE: running a worker under the 2026-07-14 sortition upgrade (claimSession flow, new image, Redis requirement, on-chain answer reads), with a 4-model all-tx proof run.
- **[how-to-test-the-new-models.md](how-to-test-the-new-models.md)** - step-by-step: send a real prompt to gpt-oss/glm on testnet in ~5 minutes (no chat UI needed), answer decrypted from the on-chain blob.
